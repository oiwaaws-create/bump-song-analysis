...
const MEMBERS = [
  ...
  },
  {
    ...
    role: "Guitar",
    initial: "増",
    bio: `通称ヒロ。46歳に見えないくらい若く、年を取らない男と言われている。
30年経ってもライブでは口下手であり、毎回前日食べたごはんの話をする。
秀ちゃんとはよくトムジェリみたいな小競り合いをしてる。`
  },
  {
    id: "naoi",
    name: "直井 由文",
    role: "Bass",
    initial: "直",
    bio: `通称チャマ。小学校時代、自販機で100円ジュースを奢った際お坊ちゃまと言われたことが名前の由来。
バンド内の盛り上げ役で、他3人よりも髪色とかが派手で、メンバー１精神的に若い。`
  },
  {
    id: "masu",
    name: "升 秀夫",
